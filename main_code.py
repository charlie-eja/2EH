...
def simulation_umap():
    ...
    UMPA_plot.umap_plot_3D(data=umap_data,labels=y)
...
def main():
    ...
    # interval_data = samping_method.time_sampling(data, interval_count=1800, start_time='2023-01-02 ', end_time='2023-01-03 22:00:00 ')
    # print('end')
